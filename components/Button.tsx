...
export const Button : React.FC<IButton> = ({title, onClick, type = ButtonType.NORMAL, className}) => {
  return (
    <button 
        type="button" 
        className={`
        inline-block ${type} rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] 
